...
#pragma mark - Others
// Es destruye el contexto y crea otro, lo cual pueda dar lugar a bugs.
...
// Solo elimina los objetos sin cambiar el contexto. Lento si hay muchos objetos
// pero es más seguro.
-(void) zapAllData{
    ...
    for (NSEntityDescription *entity in self.model) {
        
        NSFetchRequest *r = [NSFetchRequest fetchRequestWithEntityName:[entity name]];
        r.returnsObjectsAsFaults = YES;
        r.includesPropertyValues = NO;
        
        objs = [self executeFetchRequest:r
